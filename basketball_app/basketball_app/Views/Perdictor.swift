...
//  basketball_app
//
//  Created by Viktor on 17/05/2023.
//

import Foundation
import Vision

typealias ThrowingClassifier = BasketballFreetrowWorkout_1
...
class Predictor {
    ...
    func estimation(sampleBuffer: CMSampleBuffer) {
        ...
        do{
            ...
            print("Unable to perform the reguest, with error: \(error)")
        }
    }
    ...
    func resetMultiArray(_ predictionWindow: MLMultiArray, wtih value: Double = 0.0) throws {
